...
async function getRecipes() {
    ...
    let recpe = localStorage.getItem('recipes');
    if (recpe != null) {
        return JSON.parse(recpe);
    }
    /**************************/
    ...
    let prmse = new Promise(async(resolve, reject) => {
        ...
        for (let i = 0; i < RECIPE_URLS.length; i++) {
            ...
            try {
                ...
                let rcps = await fetch(RECIPE_URLS[i]);
